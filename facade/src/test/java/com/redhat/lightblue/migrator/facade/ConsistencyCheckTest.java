...
public class ConsistencyCheckTest {
    ...
    public void testConsistencyWithNull() {
        ...
        Assert.assertTrue(daoFacadeExample.checkConsistency(null, null, "saveCountry", null));
        Assert.assertFalse(daoFacadeExample.checkConsistency(c1, null, "savePerson", null));
        Assert.assertFalse(daoFacadeExample.checkConsistency(null, c1, "savePerson", null));
    }
