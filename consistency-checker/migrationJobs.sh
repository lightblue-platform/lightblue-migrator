...
while true; do
    ...
    [ $AVAILABLE_DATE"x" == "x" ] || echo  \"whenAvailableDateFu\" : \"$( date +%Y%m%d --date "$AVAILABLE_DATE")T00:00:00.000+0000\",
    [ $AVAILABLE_DATE"x" != "x" ] || echo  \"whenAvailableDateFu\" : \"$( date +%Y%m%d --date "$next")T00:00:00.000+0000\",
