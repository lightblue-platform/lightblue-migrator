...
/**
 * Compares two documents json documents, and builds an
 * list of all changes
 *
...
public abstract class DocCompare<BaseType,ValueType,ObjectType,ArrayType>  {
    ...
    public static final class InvalidArrayIdentity extends Exception {
        public InvalidArrayIdentity(List<String> p) {
    ...
    public static final class DuplicateArrayIdentity extends Exception {
        public DuplicateArrayIdentity(List<String> p) {
            this
                (JsonDiff.toString(p));
        }
    ...
    public static abstract class Delta<T> {
        ...
        public Delta(List<String> field1,List<String> field2) {
    ...
    public static class Addition<T> extends Delta<T> {
        ...
        public Addition(List<String> field2,T addedNode) {
            super(null,field2);
            this.addedNode=addedNode;
        }
    ...
    public static class Removal<T> extends Delta<T> {
        ...
        public Removal(List<String> field1,T removedNode) {
            super(field1,null);
            this.removedNode=removedNode;
        }
    ...
    public static class Move<T> extends Delta<T> {
        ...
        public Move(List<String> field1,List<String> field2,T movedNode) {
            super(field1,field2);
            this.movedNode=movedNode;
        }
    ...
    public static class Modification<T> extends Delta<T> {
        ...
        public Modification(List<String> field1,T node1,List<String> field2,T node2) {
            super(field1,field2);
            this.node1=node1;
            this.node2=node2;
        }
    ...
    public Difference<BaseType> compareNodes(List<String> field1,
                                             BaseType node1,
                                             List<String> field2,
                                             BaseType node2) 
        throws InvalidArrayIdentity, DuplicateArrayIdentity {
    ...
    public IdentityExtractor getArrayIdentityExtractor(List<String> arrayField) {
    ...
    public Difference<BaseType> compareArrays(List<String> field1,
                                              ArrayType node1,
                                              List<String> field2,
                                              ArrayType node2) 
        throws InvalidArrayIdentity, DuplicateArrayIdentity {
     ...
     */
    public Difference<BaseType> compareArraysNoId(List<String> field1,
                                                  ArrayType node1,
                                                  List<String> field2,
                                                  ArrayType node2) 
        throws InvalidArrayIdentity, DuplicateArrayIdentity {
        ...
        for(assoc.start1();assoc.hasNext1();) {
            ...
            field1.add(Integer.toString(index1));
        ...
        for(assoc.start2();assoc.hasNext2();) {
            ...
            field2.add(Integer.toString(index));
    ...
    private Map<Object,Integer> getIdentityMap(List<String> field,ArrayType array,IdentityExtractor idex)
        throws InvalidArrayIdentity, DuplicateArrayIdentity {
        ...
        for(int i=0;i<size;i++) {
            ...
            if(id==null)
                throw new InvalidArrayIdentity(JsonDiff.toString(field)+"."+i);
            if(identities.put(id,i)!=null)
                throw new DuplicateArrayIdentity(JsonDiff.toString(field)+"."+i);
        }
        return identities;
    }
    
    private static void pop(List<String> l) {
        l.remove(l.size()-1);
    }
}
